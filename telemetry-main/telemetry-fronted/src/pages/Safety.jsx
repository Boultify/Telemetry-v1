...
=======
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:5000/api/profile/latest')
      .then(res => res.json())
    ...
    const interval = setInterval(() => {
      fetch(`http://localhost:5000/api/telemetry/latest/${deviceId}`)
        .then(res => res.json())
    ...
    return () => clearInterval(interval);
  },[deviceId]); // Added deviceId dependency
>>>>>>> 10094c2d7d52891488b78219451e613e4315e280
